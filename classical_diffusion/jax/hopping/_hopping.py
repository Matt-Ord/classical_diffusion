...
def solve_ensemble[L: CanonicalLattice](
    system: L,
    time_span: TimeSpan,
    ...
    *,
    ...
    results = jax.vmap(_run_hopping_simulation_jit, in_axes=(None, 0, None, 0))(
        system, initial_condition, times, keys
    )
...
def get_deterministic_probabilities[L: CanonicalLattice](
    system: L,
    time_span: TimeSpan,
    shape: tuple[int, ...],
) -> tuple[jnp.ndarray, jnp.ndarray]:
